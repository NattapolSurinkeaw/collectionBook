...
import { svCreateCateBook } from '@/services/author_publisher_illust/categorybook.service';
...
export default function ModalAddCate({open, handleClose, setCateBook}) {
  ...
  const submit = () => {
    ...
    svCreateCateBook(formData).then((res) => {
      console.log(res)

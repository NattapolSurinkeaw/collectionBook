                ...
                <div className="py-2 px-10 flex gap-4">
                        ...
                        {roles.length === 0 ? (
                            ...
                            roles.map((role) => (
                              <li
                                ...
                                className={`${
                                  filterRole === role.id
                                    ? "border-b-2 border-blue-600 cursor-default"
                                    : "cursor-pointer"
                                }`}
                              >
                                <span className="p-4">
                    ...
                    <div className="w-full flex flex-wrap gap-4 h-[600px] overflow-auto p-4">
                        {categories.map((cate) => (
                            <div
                                key={cate.id}
                                className="flex flex-col gap-2 border shadow-md w-[168px] h-[212px] rounded-md p-2"
                            >
                                <div className="flex justify-center">
                                    <img
                                        src={`${
                                            cate.cate_thumbnail
                                                ? cate.cate_thumbnail
                                                : "/image/emptyProfile.jpg"
                                        }`}
                                        className="border p-1 rounded-lg w-full h-20"
                                        alt=""
                                    />
                                </div>
                                <div className="text-center">
                                    ...
                                    <h3 className="w-full overflow-hidden">
                                        ({cate.id})
                                    </h3>
                                    <h3 className="">
                                        <input

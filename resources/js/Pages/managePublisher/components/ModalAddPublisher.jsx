...
import { svCreatePublisher } from '@/services/author_publisher_illust/publisher.service';
...
export default function ModalAddPublisher({open, handleClose, setPublisher}) {
  ...
  const submit = () => {
    ...
    svCreatePublisher(formData).then((res) => {
      console.log(res)

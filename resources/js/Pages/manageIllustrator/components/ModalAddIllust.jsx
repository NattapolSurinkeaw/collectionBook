...
import { svCreateIllustrator } from '@/services/author_publisher_illust/illust.service';
...
export default function ModalAddIllust({open, handleClose, setIllustrator}) {
  ...
  const submit = () => {
    ...
    svCreateIllustrator(formData).then((res) => {
      console.log(res)
      if(res.status == 'success') {
        setIllustrator(prevIllust => [...prevIllust, res.illust]);
        handleClose()
      }
    })
  }
